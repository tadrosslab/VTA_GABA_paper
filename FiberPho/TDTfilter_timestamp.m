%Written 03/2023 by SB
%Cleaned up and commented 3/2024 by SB

%Modified from TDTfilter code at https://www.tdt.com/docs/sdk/offline-data-analysis/offline-data-matlab/getting-started/
%Modified to take external behavioral timestamps for filtering analysis

function data = TDTfilter_timestamp(data, varargin)
...
%           ie input 'VALUES', timestamps
%      'TIME', specify onset/offset pairs relative to  VALUES. 
...
VALID_PARS = {'VALUES','TIME','KEEPDATA'};
...
if ~isempty(VALUES)
    ...
    endRange = VALUES(2:end)-1;
    endRange(end+1) = inf;
    time_ranges = [VALUES'; endRange'];
